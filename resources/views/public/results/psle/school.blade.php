        ...
        <div class="container mx-auto px-4">
            ...
            @else
                ...
                <div class="barcode-container" style="margin-top: 1.5rem; text-align: center; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                    <div style="font-size: 16px; font-weight: bold; color: #003366; margin-bottom: 4px; letter-spacing: 1px;">
                        STANDARD SEVEN OFFICIAL RESULT
                    </div>
                    <div class="barcode-text" style="font-size: 80px; line-height: 0.85; color: #000000;">
                        *{{ strtoupper($school->code) }}*
                    </div>
                    <div style="font-family: monospace !important; font-size: 14px; font-weight: bold; letter-spacing: 4px; color: #333333; margin-top: -15px;">
                        *{{ strtoupper($school->code) }}*
                    </div>
                </div>
            @endif
