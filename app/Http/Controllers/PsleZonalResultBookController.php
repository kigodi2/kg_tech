...
use App\Services\Results\ZonalResultBookDataService;
use App\Services\Results\PsleZonalResultBookPdfService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class PsleZonalResultBookController extends Controller
{
    public function __construct(
        protected ZonalResultBookDataService $dataService,
        protected PsleZonalResultBookPdfService $pdfService
    ) {}
    ...
    public function show(Request $request)
    {
        ...
        return view('evaluations.psle.zonalwise.result-book.show', [
    ...
    public function pdf(Request $request)
    {
        ...
        // Generate PDF
        $tempPath = tempnam(sys_get_temp_dir(), 'zonal_result_book_') . '.pdf';
        ...
        $filename = 'Kitabu_cha_Matokeo_PSLE_Kanda_TASIDO_' . $examYearValue . '.pdf';
